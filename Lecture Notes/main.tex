...
\hline
Performance (\burmesefont စွမ်းဆောင်ရည်) & Generally faster; the CPU executes native machine code directly. (\burmesefont ယေဘံုယျအားဖြင့် ပိုမိုမြန်ဆန်လေ့ရှိသည်။ CPU သည် machine code ကို တိုက်ရိုက် အလုပ်လုပ် (run) စေနိုင်သည်။) & Generally slower; the interpreter adds overhead during execution. (\burmesefont ယေဘုံယျအားဖြင် ပိုနှေးသည်။ Interpreter သည် ကုဒ်ကို အလုပ်လုပ်စေရန် အဆင့်ဆင့် လုပ်ဆောင်ရသောကြောင့် ဖြစ်သည်။)\\
\hline
...
\hline
Debugging (\burmesefont ကွန်ပျူတာပရိုဂရမ်မှ အပြစ်ကို ရှာဖွေဖယ်ရှားခြင်)& Errors are caught during the "build" phase before the program runs.(\burmesefont ပရိုဂရမ် မစတင်မီ build phase (တည်ဆောက်သည့်အဆင့်) တွင် error (အမှား) များကို ရှာဖွေတွေ့ရှိနိုင်သည်။) & Errors are discovered at runtime when the specific line is executed. (\burmesefont ပရိုဂရမ် အလုပ်လုပ်နေစဉ်အတွင်း သက်ဆိုင်ရာကုဒ်လိုင်းသို့ ရောက်ရှိမှသာ အမှားများကို တွေ့ရှိရသည်။)\\
\hline
\end{tabular}
\end{center}
